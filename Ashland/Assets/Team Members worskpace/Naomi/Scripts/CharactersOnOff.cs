...
public class CharactersOnOff : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X) && CharactersOn == true) { CharactersOn = false; SamundrasModelsOn = true; print("turn off Characters"); CharacterModels.SetActive(false); SamundrasModels.SetActive(true); }
    }
}
